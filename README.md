...
version 19.0.0, [NodeJS](https://nodejs.org/en) version 22.11.0 and [NPM](https://nodejs.org/en) version 10.9.0 and [Tailwind CSS](https://tailwindcss.com/) version 3.4.13.
